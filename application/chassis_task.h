...
//[Lance] chassis spin speed in spin mode
#define SPIN_SPEED 4.0f
...
//底盘电机速度环PID
#define M3505_MOTOR_SPEED_PID_KP 10000.0f // default 15000.0f
#define M3505_MOTOR_SPEED_PID_KI 0.0f // default 10.0f
...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 10.0f // default 40.0f 
...
typedef enum
{
  ...
  CHASSIS_VECTOR_RAW,                 //control-current will be sent to CAN bus derectly.
	CHASSIS_VECTOR_SPIN									//chassis will spin 
} chassis_mode_e;
