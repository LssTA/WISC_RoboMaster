...
void set_cali_gimbal_hook(const uint16_t yaw_offset, const uint16_t pitch_offset, const fp32 max_yaw, const fp32 min_yaw, const fp32 max_pitch, const fp32 min_pitch)
{
    ...
    gimbal_control.gimbal_pitch_motor.max_relative_angle = PITCH_MAX_ANGLE;
    gimbal_control.gimbal_pitch_motor.min_relative_angle = PITCH_MIN_ANGLE;
}
...
static void gimbal_init(gimbal_control_t *init)
{
    ...
    init->gimbal_yaw_motor.relative_angle_set = INIT_YAW_POSI;
    init->gimbal_yaw_motor.motor_gyro_set = init->gimbal_yaw_motor.motor_gyro;


    init->gimbal_pitch_motor.absolute_angle_set = init->gimbal_pitch_motor.absolute_angle;
    init->gimbal_pitch_motor.relative_angle_set = INIT_PITCH_POSI;
...
/**
  * @brief          gimbal control mode :GIMBAL_MOTOR_GYRO, use euler angle calculated by gyro sensor to control. 
  * @param[in]      bypass: 1 to bypass max angle check
  * @param[out]     gimbal_motor: yaw motor or pitch motor\
  * @retval         none
  */
/**
