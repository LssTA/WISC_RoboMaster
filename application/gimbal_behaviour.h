...
typedef enum
{
  ...
  GIMBAL_INIT,           
  GIMBAL_CALI,           
  GIMBAL_ABSOLUTE_ANGLE, // uses gyro loop (when in spinning and independent mode)
  GIMBAL_RELATIVE_ANGLE, // uses encoder loop (when in following mode)
  GIMBAL_MOTIONLESS,     // no power (switch down)
} gimbal_behaviour_e;
