...
static void chassis_set_contorl(chassis_move_t *chassis_move_control)
{
    ...
    if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_FOLLOW_GIMBAL_YAW)
    {
        ...
        //rotate chassis direction, make sure forward direction follow gimbal 
     ...
     // [Lance] spinning is essentially the same as "chassis vector follow gimbal yaw"
      ...
      fp32 sin_yaw = 0.0f, cos_yaw = 0.0f;
        ...
        // [Lance] Here is different, the angular velocity is directly assigned and fixed
...
{
    // [Lance] model not suitable for our robot
